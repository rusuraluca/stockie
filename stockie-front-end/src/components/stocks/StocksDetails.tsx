    ...
    return (
        <Container>
            ...
            <CardContent>
                ...
                <p><b>Added by: </b><a href={`/users/${stock?.user?.id}/details`}>{stock?.user?.username}</a></p>
                ...
                <Button style={{margin: "10px 10px 0 0px"}} variant="dark" href={`/stocks`}>
                    <ArrowBackIcon style={{color: "white"}}/>
                    Go Back
                </Button>
                <Button style={{margin: "10px 10px 0 0px"}} variant="success" href={`/stocks/${stockId}/edit`}>
                    <EditIcon style={{color: "white"}}/>
                    Edit stock details
                </Button>
                <Button style={{margin: "10px 10px 0 0px"}} variant="danger" href={`/stocks/${stockId}/delete`}>
